# Django settings for realbuahto project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    # ('Hans de Jong', 'admin@eatingpanda.com'),
)
...
MEDIA_ROOT = '/home/ikke/panda/realbuahto/media/'
...
SECRET_KEY = 'cup2ftb+j@vh%v9r@m!gp7n9r6abxtu!b9^uw9gzqgd7x*z^y+'
